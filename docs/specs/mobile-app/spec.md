...
| 16 | Background/crash | REQ-M-50, REQ-M-51 | Stop capture on background, flush queue, resume on foreground |
...
| 16 | Background/crash | REQ-M-50, REQ-M-51 | Lifecycle-aware: stop analysis on STOPPED, flush queue, resume on STARTED |
...
| 20 | Sightings handling | REQ-M-67 | Parse recent_sightings response, log to DebugLog, increment counter |
| 21 | Alert lifecycle | REQ-M-64, REQ-M-68 | Start timer in startPipeline(), subscribe+cancel in stopPipeline() (refresh TTL) |
